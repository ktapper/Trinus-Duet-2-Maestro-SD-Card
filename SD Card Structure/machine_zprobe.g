...
; M558 P1 X0 Y0 Z1 H5 A10 S0.01 F20 T5000 ; Set Z probe type -- ENABLE IR_PROBE  ; Set Z probe type -- Enable IR_PROBE Talryyn
...
M558 P1 X0 Y0 Z1 H5 A10 S0.01 F1000 T5000 ; Set Z probe type -- ENABLE IR_PROBE  ; Set Z probe type -- Enable IR_PROBE Talryyn
...
; G31 P999 X-43 Y34 Z12.996 ; Set Z probe (Metrol switch) trigger value, offset. X and Y offset need to be measured!
G31 P450 X-23 Y-15.25 Z2.60  ; Set Z probe (IR) trigger value and offset
